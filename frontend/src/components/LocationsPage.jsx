    ...
    const sampleLocations = [
      {
        ...
        coordinates: [28.6139, 77.2090],  // Latitude, Longitude for New Delhi
        boundary: [
          [28.6, 77.2],
          [28.7, 77.2],
          [28.7, 77.3],
      ...
      },
      {
        ...
        image: "https://via.placeholder.com/150",
        coordinates: [19.0760, 72.8777],  // Latitude, Longitude for Mumbai
        boundary: [
          [19.07, 72.87],
          [19.08, 72.87],
          [19.08, 72.88],
    ...
    <div className="bg-gradient-to-r from-blue-900 to-purple-900 min-h-screen text-white">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mt-8 mb-4">
          <h1 className="text-4xl sm:text-5xl font-bold text-cyan-400 neonGlow">Solve The Mystery</h1>
        </div>
