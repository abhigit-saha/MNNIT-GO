    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl space-y-8 md:space-y-0">
        ...
        <div className="text-left w-full md:w-1/3 space-y-4">
          <span className="text-xs font-semibold text-neonPink uppercase tracking-wide">NEW</span>
          <h1 className="text-4xl sm:text-5xl font-bold text-textLight leading-tight">
            Join the <span className="text-neonPink">scAvengers</span> platform for <span className="text-neonPurple">everyone</span>.
          </h1>
          <p className="text-lg text-textLight">
            Explore our college resources, participate in events, and enjoy the thrill of the hunt!
          </p>
          <button 
        ...
        <div className="w-full md:w-1/3 flex justify-center items-center">
          <img src={pandaImage} alt="Panda Character" className="w-full max-w-xs h-auto" />
        </div>

        {/* Right Description */}
        <div className="text-left w-full md:w-1/3 space-y-6">
          <h2 className="text-xl font-semibold mb-4 text-neonPink">Upcoming Events</h2>
          <div className="space-y-4">
            <div>
              <h3 className="font-semibold text-lg">Join us for:</h3>
              <p className="text-sm text-textLight">Explore various college resources and events.</p>
            </div>
            <div className="border-t border-neonPurple pt-4">
              <h3 className="font-semibold text-lg text-neonPurple">Available Events</h3>
              <div className="grid grid-cols-1 gap-2 mt-2 text-center">
                <Link to='/hunts/6725d24bca4da6131cffda4c'>
                  <div className="p-2 rounded-lg bg-backgroundDark text-neonPink border border-neonPink">Central Library</div>
                </Link>
                <Link to='/hunts/6725d24bca4da6131cffda4a'>
                  <div className="p-2 rounded-lg bg-backgroundDark text-neonPink border border-neonPink">Admin Building</div>
                </Link>
                <Link to='/hunts/6725d24bca4da6131cffda4b'>
                  <div className="p-2 rounded-lg bg-backgroundDark text-neonPink border border-neonPink">Cafe 96</div>
                </Link>
              </div>
            </div>
          </div>
