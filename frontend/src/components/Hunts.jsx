    ...
    if (hunts.length === 0) {
        return (
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-center mb-8">Available Scavenger Hunts</h1>
                <p className="text-center text-gray-600">No hunts available at the moment.</p>
            </div>
        );
    }
                        ...
                        <div className="relative h-48">
                            ...
                            <div className="absolute top-2 right-2">
                                <span className={`px-3 py-1 rounded-full text-sm ${
                                    hunt.difficulty === 'Easy' ? 'bg-green-500' :
                                    hunt.difficulty === 'Medium' ? 'bg-yellow-500' :
                                    'bg-red-500'
                                } text-white`}>
                                    {hunt.difficulty}
                                </span>
